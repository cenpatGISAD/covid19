...
informes_Neuquen_mas_reciente$Texto <- with(informes_Neuquen_mas_reciente, paste0('<p>', informes_Neuquen_mas_reciente$Localidad,'<p></p>',
...
informes_Santa_Cruz_mas_reciente$Texto <- with(informes_Santa_Cruz_mas_reciente, paste0('<p>', informes_Santa_Cruz_mas_reciente$Localidad,'<p></p>',
...
informes_Tierra_del_Fuego_mas_reciente$Texto <- with(informes_Tierra_del_Fuego_mas_reciente, paste0('<p>', informes_Tierra_del_Fuego_mas_reciente$Localidad,'<p></p>',
...
informes_Rio_Negro_mas_reciente$Texto <- with(informes_Rio_Negro_mas_reciente, paste0('<p>', informes_Rio_Negro_mas_reciente$Localidad,'<p></p>',
                                        '<p>',"Confirmados: ", informes_Rio_Negro_mas_reciente$Confirmados,  '<p></p>', "Casos sospechosos: ", informes_Rio_Negro_mas_reciente$Sospechosos,  '</p>',
...
informes_Chubut_sumatoria_diaria <- informes_Chubut %>% # Start by defining the original dataframe, AND THEN...
  ...
  summarise( # Now you define your summary variables with a name and a function...
    ...
    confirmados_acum = sum(confirmados_acum),
    muertos_acum = sum(muertos_acum)
  )
...
IND_adm_Patagonia <- readShapeSpatial("/mnt/28EC75CE33EA541A/temporales/Coronavirus/estadisticas/IGN/SHAPES/argentinaLowADM1_limpio_solo_Patagonia.shp")
...
valueBox(
  value = paste(format(ultimo_resumen_La_Pampa$Confirmados_acum, big.mark = ","), "", sep = " "),
...
valueBox(
  value = paste(format(ultimo_resumen_La_Pampa$Curados_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
  caption = "Personas curadas", # (tasa de mortalidad [100*Casos de muerte/Casos confirmados])
...
valueBox(
  value = paste(format(ultimo_resumen_La_Pampa$Activos_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
valueBox(
  value = paste(format(ultimo_resumen_La_Pampa$Fallecidos_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
plotly::plot_ly(data = resumenes_diarios_prov_Pat[resumenes_diarios_prov_Pat$Provincia=="La Pampa",]) %>%
  plotly::add_trace(
    x = ~Fecha,
    # y = ~active_cum,
    y = ~Confirmados_acum,
...
plotly::layout(
  title = "",
  yaxis = list(title = "Número acumulado de casos", range = c(0,(max(ultimo_resumen_La_Pampa$Confirmados_acum)+10))),
...
valueBox(
  value = paste(format(ultimo_resumen_Neuquen$Confirmados_acum, big.mark = ","), "", sep = " "),
  caption = "Total de casos confirmados",
  icon = "fas fa-user-md",
  color = confirmed_color
)
...
valueBox(
  value = paste(format(ultimo_resumen_Neuquen$Curados_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
valueBox(
  value = paste(format(ultimo_resumen_Neuquen$Activos_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
valueBox(
  value = paste(format(ultimo_resumen_Neuquen$Fallecidos_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
plotly::layout(
  title = "",
  yaxis = list(title = "Número acumulado de casos", range = c(0,(max(ultimo_resumen_Neuquen$Confirmados_acum)+10))),
  #xaxis = list(title = "Fecha"),
  xaxis = list(
    type = 'date',
    title = "Fecha"),#,, tickangle=-90, type='category', 
...
valueBox(
  value = paste(format(ultimo_resumen_Río_Negro$Confirmados_acum, big.mark = ","), "", sep = " "),
  caption = "Total de casos confirmados",
  icon = "fas fa-user-md",
  color = confirmed_color
)
...
valueBox(
  value = paste(format(ultimo_resumen_Río_Negro$Curados_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
valueBox(
  value = paste(format(ultimo_resumen_Río_Negro$Activos_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
valueBox(
  value = paste(format(ultimo_resumen_Río_Negro$Fallecidos_acum, big.mark = "."), #" (",
    #round(100 * casos_muerte_Chubut / casos_confirmados_Chubut, 1),
    #"%)",
    sep = ""
  ),
...
plotly::layout(
  title = "",
  list(title = "Número acumulado de casos", range = c(0,(max(informes_Rio_Negro_mas_reciente$Confirmados_acum)+10))),
  #xaxis = list(title = "Fecha"),
  xaxis = list(
    type = 'date',
    title = "Fecha"),#,, tickangle=-90, type='category', 
...
plotly::layout(
  title = "",
  yaxis = list(title = "Número acumulado de casos", range = c(0,(max(ultimo_resumen_Chubut$Confirmados_acum)+10))),
  #xaxis = list(title = "Fecha"),
  xaxis = list(
    type = 'date',
    title = "Fecha"),#,, tickangle=-90, type='category', 
...
valueBox(
  value = paste(format(ultimo_resumen_Santa_Cruz$Confirmados_acum, big.mark = ","), "", sep = " "),
  caption = "Total de casos confirmados",
  icon = "fas fa-user-md",
  color = confirmed_color
)
...
plotly::layout(
  title = "",
  yaxis = list(title = "Número acumulado de casos", range = c(0,(max(ultimo_resumen_Santa_Cruz$Confirmados_acum)+10))),
  #xaxis = list(title = "Fecha"),
  xaxis = list(
    type = 'date',
    title = "Fecha"),#,, tickangle=-90, type='category', 
...
valueBox(
  value = paste(format(ultimo_resumen_Tierra_del_Fuego$Confirmados_acum, big.mark = ","), "", sep = " "),
  caption = "Total de casos confirmados",
  icon = "fas fa-user-md",
  color = confirmed_color
)
...
plotly::layout(
  title = "",
  yaxis = list(title = "Número acumulado de casos", range = c(0,(max(ultimo_resumen_Tierra_del_Fuego$Confirmados_acum)+10))),
  #xaxis = list(title = "Fecha"),
  xaxis = list(
    type = 'date',
    title = "Fecha"),#,, tickangle=-90, type='category', 
...
mapa_Chubut <- leaflet() %>% addProviderTiles(providers$Stamen.TerrainBackground) %>% #OpenStreetMap
  ...
  addPolygons(data=IND_adm_Chubut, 
              ...
              labelOptions = labelOptions(
                ...
                textsize = "10px",
                 direction = "auto"))  %>% 
            addCircleMarkers(data = informes_Rio_Negro_mas_reciente,
                    popup = ~Confirmados,
                    stroke = TRUE,
                    color = "black",
                    #radius = 3,#~ifelse(Confirmados > 20, 22, Confirmados),
                    fillColor = ~pal(`Confirmados`),
                    label = lapply(informes_Rio_Negro_mas_reciente$Texto, htmltools::HTML),
                    #fillColor = ~pal(OCD_Program),
                    fillOpacity = 0.9,
                      #clusterOptions = markerClusterOptions(removeOutsideVisibleBounds = F),
                    labelOptions = labelOptions(noHide = F, direction = "auto"))  %>% 
            addCircleMarkers(data = informes_La_Pampa_mas_reciente,
                    popup = ~Confirmados,
                    stroke = TRUE,
                    color = "black",
                    #radius = 3,#~ifelse(Confirmados > 20, 22, Confirmados),
                    fillColor = ~pal(`Confirmados`),
                    label = lapply(informes_La_Pampa_mas_reciente$Texto, htmltools::HTML),
                    #fillColor = ~pal(OCD_Program),
                    fillOpacity = 0.9,
                      #clusterOptions = markerClusterOptions(removeOutsideVisibleBounds = F),
                    labelOptions = labelOptions(noHide = F, direction = "auto"))  %>% 
              addCircleMarkers(data = informes_Neuquen_mas_reciente,
                    popup = ~Confirmados,
                    stroke = TRUE,
                    color = "black",
                    #radius = 3,#~ifelse(Confirmados > 20, 22, Confirmados),
                    fillColor = ~pal(`Confirmados`),
                    label = lapply(informes_Neuquen_mas_reciente$Texto, htmltools::HTML),
                    #fillColor = ~pal(OCD_Program),
                    fillOpacity = 0.9,
                      #clusterOptions = markerClusterOptions(removeOutsideVisibleBounds = F),
                    labelOptions = labelOptions(noHide = F, direction = "auto"))  %>% 
            addCircleMarkers(data = informes_Santa_Cruz_mas_reciente,
                    popup = ~Confirmados,
                    stroke = TRUE,
                    color = "black",
                    #radius = 3,#~ifelse(Confirmados > 20, 22, Confirmados),
                    fillColor = ~pal(`Confirmados`),
                    label = lapply(informes_Santa_Cruz_mas_reciente$Texto, htmltools::HTML),
                    #fillColor = ~pal(OCD_Program),
                    fillOpacity = 0.9,
                      #clusterOptions = markerClusterOptions(removeOutsideVisibleBounds = F),
                    labelOptions = labelOptions(noHide = F, direction = "auto")) %>% 
            addCircleMarkers(data = informes_Tierra_del_Fuego_mas_reciente,
                    popup = ~Confirmados_acum,
                    stroke = TRUE,
                    color = "black",
                    #radius = 3,#~ifelse(Confirmados > 20, 22, Confirmados),
                    fillColor = ~pal(`Confirmados_acum`),
                    label = lapply(informes_Tierra_del_Fuego_mas_reciente$Texto, htmltools::HTML),
                    #fillColor = ~pal(OCD_Program),
                    fillOpacity = 0.9,
                      #clusterOptions = markerClusterOptions(removeOutsideVisibleBounds = F),
                    labelOptions = labelOptions(noHide = F, direction = "auto"))
