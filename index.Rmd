...
informes_Rio_Negro_mas_reciente$Texto <- with(informes_Rio_Negro_mas_reciente, paste0('<p>', informes_Rio_Negro_mas_reciente$Localidad,'<p></p>',
                                        ...
                                        '<p>',"Activos: ", informes_Rio_Negro_mas_reciente$Activos, '<p></p>',"Fallecidos: ", informes_Rio_Negro_mas_reciente$Fallecidos,  '</p>',
...
plotly::layout(
  title = "",
  yaxis = list(title = "Número acumulado de casos", range = c(0,(max(resumenes_diarios_prov_Pat$Confirmados_acum)+10))),
