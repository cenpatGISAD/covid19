...
ultimo_resumen_Río_Negro <- resumenes_diarios_prov_Pat[resumenes_diarios_prov_Pat$Provincia=="Río Negro" & resumenes_diarios_prov_Pat$Fecha== max(resumenes_diarios_prov_Pat$Fecha),]


ultimo_resumen_Chubut <- resumenes_diarios_prov_Pat[resumenes_diarios_prov_Pat$Provincia=="Chubut" & resumenes_diarios_prov_Pat$Fecha== max(resumenes_diarios_prov_Pat$Fecha),]
...
informes_Rio_Negro_mas_reciente$Texto <- with(informes_Rio_Negro_mas_reciente, paste0('<p>', informes_Rio_Negro_mas_reciente$Localidad,'<p></p>',
                                        ...
                                        '<p></p>',"Fecha: ", informes_Rio_Negro_mas_reciente$Fecha,  '</p>'))
...
bins <- c(0, 1, 10, 20, 30, 40, 50, 60, 70)
...
mapa_Chubut <- leaflet() %>% addProviderTiles(providers$OpenStreetMap) %>% 
  addPolygons(data=IND_adm_Chubut, 
            ...
            addCircleMarkers(data = informes_Rio_Negro_mas_reciente,
                    popup = ~Confirmados,
                    stroke = FALSE,
                    radius = ~ifelse(Confirmados > 20, 22, Confirmados),
